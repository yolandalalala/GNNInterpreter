...
class SimpleGCNClassifier(nn.Module):
    def __init__(self, hidden_channels, node_features, num_classes, num_layers, norm=None, act=nn.GELU, dropout=0):
        super().__init__()
    ...
    def forward(self, batch=None, embeds=None, edge_weight=None, temperature=0.05):
        ...
        return dict(logits=h, probs=F.softmax(h, dim=-1), feats=feats, embeds=embeds)